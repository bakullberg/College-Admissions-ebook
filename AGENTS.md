# AI Agent Instructions — College Admissions Roadmap

Welcome, Agent. You have been asked to generate, edit, or validate content for
the **College Admissions Roadmap** intelligent textbook.
...
| | |
|---|---|
| Book title | College Admissions Roadmap |
| Published site | https://bakullberg.github.io/College-Admissions-ebook/ |
| Repository | https://github.com/bakullberg/College-Admissions-ebook |
...
- The published lesson URL is
  `https://bakullberg.github.io/College-Admissions-ebook/sims/<sim-id>/`. Always
